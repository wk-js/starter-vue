...
import I18nData from 'consts/i18n.json.ejs'
...
// function t(key, obj) {
//   const translations = window.PAGEDATA.translations
...
// function hasTranslation(key, obj) {
//   const value = t(key, obj)
//   return !(!value || value.length === 0 || value === key)
// }

// function tComponent(tagOrOptions, key, obj) {
//   let tag = tagOrOptions, attrs = {}
...
//   let _attrs = Object.keys(attrs).map(function(key) {
//     if (key === 'tag') {
//       return ''
//     }
...
//   return {
//     template: `<${tag} ${_attrs}>${t(key, obj)}</${tag}>`
//   }
// }
